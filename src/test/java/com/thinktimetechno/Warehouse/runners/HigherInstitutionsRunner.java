package com.thinktimetechno.Warehouse.runners;
...
@Test
@CucumberOptions(
        features = "src/test/resources/features/WarehouseFeatures/HigherInstitutions.feature",
        glue = {"com.thinktimetechno.projects.website.Warehouse.stepdefinitions",
        ...
        , monochrome = true,
        tags = "@HigherInstitutions"
)

public class HigherInstitutionsRunner extends AbstractTestNGCucumberTests {
    @Override
