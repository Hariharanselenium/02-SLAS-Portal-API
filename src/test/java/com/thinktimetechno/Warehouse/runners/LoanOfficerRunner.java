...
@Test
@CucumberOptions(
        features = "src/test/resources/features/WarehouseFeatures/LoanOfficer.feature",
        ...
        , monochrome = true,
        tags = "@LoanOfficerTest"
)

public class LoanOfficerRunner extends AbstractTestNGCucumberTests {
    @Override
